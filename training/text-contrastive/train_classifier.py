...
def train(opt):
    ...
    if opt.dataset == 'faidset' or opt.dataset == 'llmdetectaive' or opt.dataset == 'hart' or opt.dataset == 'faidsetv2':
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", 
                        type=str, 
                        default="faidsetv2", 
                        help="faidset, llmdetectaive, hart, faidsetv2")
    #path to retrieve dataset
    parser.add_argument("--path", 
                        type=str, 
                        default="data/FAIDSetv2")
    ...
    parser.add_argument('--model_name', 
                        type=str, 
                        default='ZurichNLP/unsup-simcse-xlm-roberta-base')
